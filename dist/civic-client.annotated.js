...
// This http interceptor listens for authentication failures
  // @ngInject
  .factory('securityInterceptor', ["$injector", "RetryQueue", function($injector, RetryQueue) {
...
angular.module('civic.security.service', [
  ...
  .factory('security', ["$http", "$q", "$location", "queue", "$modal", function($http, $q, $location, queue, $modal) {
    'use strict';
