...
LoginFormController.$inject = ["$scope", "$state", "Security"];
...
browseConfig.$inject = ["$stateProvider", "$log"];
...
AccountCtrl.$inject = ["$scope", "$rootScope", "$log"];
...
accountConfig.$inject = ["$stateProvider", "AuthorizationProvider"];
angular.module('civic.services')
...
Security.$inject = ["$http", "$q", "$location", "RetryQueue", "dialogs", "$log"];
...
Interceptor.$inject = ["$injector", "RetryQueue"];
...
interceptorServiceConfig.$inject = ["$httpProvider"];
...
// before allowing a route change to complete
  .provider('Authorization', {
    ...
    $get: ["Security", "RetryQueue", function(Security, RetryQueue) {
      'use strict';
      var service = {
...
function subheader($rootScope, $log) {
  ...
  subheaderCtrl.$inject = ["$scope", "$element", "$attrs"];
...
subheader.$inject = ["$rootScope", "$log"];
...
typeAheadCtrl.$inject = ["$scope", "$log", "$location"];
angular.module('civic.common')
...
sessionInfo.$inject = ["ConfigService", "$log"];
angular.module('civic.common')
...
loginToolbar.$inject = ["Security", "$log"];
angular.module('civic.common')
...
AuthTestCtrl.$inject = ["$scope", "$rootScope", "$log"];
...
HelpCtrl.$inject = ["$scope", "$rootScope", "$log"];
angular.module('civic.pages')
...
CollaborateCtrl.$inject = ["$scope", "$rootScope", "$log"];
