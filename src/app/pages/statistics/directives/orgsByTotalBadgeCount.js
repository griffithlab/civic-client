(function() {
  ...
  angular.module('civic.pages')
    .directive('organizationsByTotalBadgeCount', organizationsByTotalBadgeCount)
    .controller('organizationsByTotalBadgeCountController',
                organizationsByTotalBadgeCountController);

  // @ngInject
  function organizationsByTotalBadgeCount() {
    var directive = {
      restrict: 'E',
      scope: {
        options: '=',
  ...
  // @ngInject
  function organizationsByTotalBadgeCountController($scope,
                                    $window,
                                    $rootScope,
                                    $element,
                                    d3,
                                    ...
                                    _,
                                   Stats) {
    console.log('organizationsByTotalBadgeCount loaded.');
