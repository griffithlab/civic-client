/*
* We handle Google Analytics modules outside of the bower components
* build stream in order to prevent adblockers from blocking the loading of this
* module, which will cause the Angular injector to fail during config.
* NOTE: Adblockers will still block any calls to Google from this module, so this
* won't get around adblockers.
 */
